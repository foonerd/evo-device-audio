...
pub enum Preset {
    ...
    /// is reserved for a follow-on backend; today the preset
    ...
    /// reserved for a follow-on backend; today the preset
    /// falls through to rtnetlink + polling alone.
    LinuxYoctoConnman,
    ...
    /// source is reserved for a follow-on backend; today the
