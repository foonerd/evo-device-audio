...
//!   v0.1.13 baseline: synthesises a 440 Hz sine-wave test
...
//!   playback device named in the config. v0.1.13 baseline
...
//! - Source: synthetic 440 Hz sine generator (v0.1.13 baseline).
